...
<img alt="" src="{{ 'assets/images/optimax_theme/layout-settings/ls-1.jpg' | relative_url }}">
...
<img alt="" src="{{ 'assets/images/optimax_theme/layout-settings/ls-2.jpg' | relative_url }}">
